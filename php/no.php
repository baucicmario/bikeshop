    ...
    <div>
        <div class="logpage">
                    ...
                    <th style="background-color: #252D30; border-radius: 30px; vertical-align: top;">
                        <ul>
                            <li>
                                ...
                                <div>
                                    <form action="no.php" method="get" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <label class="container2"><input type="checkbox" name="tipus[]" value="tura">TÚRA KERÉKPÁR<span class="checkmark"></span></label><br>
            ...
            if(isset($_GET["szuro"]) && !empty($_GET["szuro"])){
                ...
                filter("../bikes/no.txt", $meret, $tipus);
            } else {
                $meret=[];

                ?>
                <?php screenbikes("../bikes/no.txt"); }
                ?>
        </div>
    </div>
    </div>
